...
def TF_SetStatusFromIOError(s, error_code, context):
    return _pywrap_tensorflow_internal.TF_SetStatusFromIOError(s, error_code, context)
TF_SetStatusFromIOError = _pywrap_tensorflow_internal.TF_SetStatusFromIOError
...
def TFE_Py_RegisterJVPFunction(e):
    return _pywrap_tensorflow_internal.TFE_Py_RegisterJVPFunction(e)
TFE_Py_RegisterJVPFunction = _pywrap_tensorflow_internal.TFE_Py_RegisterJVPFunction
...
def TFE_Py_TapeSetShouldRecordBackprop(tensors):
    return _pywrap_tensorflow_internal.TFE_Py_TapeSetShouldRecordBackprop(tensors)
TFE_Py_TapeSetShouldRecordBackprop = _pywrap_tensorflow_internal.TFE_Py_TapeSetShouldRecordBackprop
...
def TFE_Py_TapeSetRecordOperation(op_type, output_tensors, input_tensors, backward_function, forward_function):
    return _pywrap_tensorflow_internal.TFE_Py_TapeSetRecordOperation(op_type, output_tensors, input_tensors, backward_function, forward_function)
TFE_Py_TapeSetRecordOperation = _pywrap_tensorflow_internal.TFE_Py_TapeSetRecordOperation

def TFE_Py_TapeSetRecordOperationBackprop(op_type, output_tensors, input_tensors, backward_function):
    return _pywrap_tensorflow_internal.TFE_Py_TapeSetRecordOperationBackprop(op_type, output_tensors, input_tensors, backward_function)
TFE_Py_TapeSetRecordOperationBackprop = _pywrap_tensorflow_internal.TFE_Py_TapeSetRecordOperationBackprop

def TFE_Py_TapeSetRecordOperationForwardprop(op_type, output_tensors, input_tensors, backward_function, forwardprop_output_indices):
    return _pywrap_tensorflow_internal.TFE_Py_TapeSetRecordOperationForwardprop(op_type, output_tensors, input_tensors, backward_function, forwardprop_output_indices)
TFE_Py_TapeSetRecordOperationForwardprop = _pywrap_tensorflow_internal.TFE_Py_TapeSetRecordOperationForwardprop
...
def TFE_Py_RecordGradient(op_name, inputs, attrs, results):
    return _pywrap_tensorflow_internal.TFE_Py_RecordGradient(op_name, inputs, attrs, results)
...
def TFE_Py_ForwardAccumulatorSetAdd(accumulator):
    return _pywrap_tensorflow_internal.TFE_Py_ForwardAccumulatorSetAdd(accumulator)
TFE_Py_ForwardAccumulatorSetAdd = _pywrap_tensorflow_internal.TFE_Py_ForwardAccumulatorSetAdd
...
def TFE_Py_ForwardAccumulatorPushState():
    return _pywrap_tensorflow_internal.TFE_Py_ForwardAccumulatorPushState()
TFE_Py_ForwardAccumulatorPushState = _pywrap_tensorflow_internal.TFE_Py_ForwardAccumulatorPushState

def TFE_Py_ForwardAccumulatorPopState():
    return _pywrap_tensorflow_internal.TFE_Py_ForwardAccumulatorPopState()
TFE_Py_ForwardAccumulatorPopState = _pywrap_tensorflow_internal.TFE_Py_ForwardAccumulatorPopState

def TFE_Py_PackJVPs(tensors):
    return _pywrap_tensorflow_internal.TFE_Py_PackJVPs(tensors)
TFE_Py_PackJVPs = _pywrap_tensorflow_internal.TFE_Py_PackJVPs
...
def TF_SetTfXlaCpuGlobalJit(enable):
    return _pywrap_tensorflow_internal.TF_SetTfXlaCpuGlobalJit(enable)
TF_SetTfXlaCpuGlobalJit = _pywrap_tensorflow_internal.TF_SetTfXlaCpuGlobalJit
...
def TFE_ContextOptionsSetLazyRemoteInputsCopy(arg1, lazy_copy):
    return _pywrap_tensorflow_internal.TFE_ContextOptionsSetLazyRemoteInputsCopy(arg1, lazy_copy)
TFE_ContextOptionsSetLazyRemoteInputsCopy = _pywrap_tensorflow_internal.TFE_ContextOptionsSetLazyRemoteInputsCopy
...
def TFE_ContextUpdateServerDef(ctx, keep_alive_secs, proto):
    return _pywrap_tensorflow_internal.TFE_ContextUpdateServerDef(ctx, keep_alive_secs, proto)
TFE_ContextUpdateServerDef = _pywrap_tensorflow_internal.TFE_ContextUpdateServerDef
...
def TF_OperationAllInputs(oper, inputs, max_inputs):
    return _pywrap_tensorflow_internal.TF_OperationAllInputs(oper, inputs, max_inputs)
TF_OperationAllInputs = _pywrap_tensorflow_internal.TF_OperationAllInputs
...
def TF_OperationGetAttrInt(oper, attr_name):
    return _pywrap_tensorflow_internal.TF_OperationGetAttrInt(oper, attr_name)
...
def TF_OperationGetAttrBool(oper, attr_name):
    return _pywrap_tensorflow_internal.TF_OperationGetAttrBool(oper, attr_name)
...
def TF_OperationGetAttrShape(oper, attr_name, num_dims):
    return _pywrap_tensorflow_internal.TF_OperationGetAttrShape(oper, attr_name, num_dims)
...
def TF_CreatePlaceholders(graph, dtypes, prefix):
    return _pywrap_tensorflow_internal.TF_CreatePlaceholders(graph, dtypes, prefix)
TF_CreatePlaceholders = _pywrap_tensorflow_internal.TF_CreatePlaceholders
...
def TF_OptimizeGraph(cluster, config_proto, metagraph, verbose, graph_id, strip_default_attributes):
    return _pywrap_tensorflow_internal.TF_OptimizeGraph(cluster, config_proto, metagraph, verbose, graph_id, strip_default_attributes)
...
def ImportGraphDef(graphdef, pass_pipeline):
    return _pywrap_tensorflow_internal.ImportGraphDef(graphdef, pass_pipeline)
ImportGraphDef = _pywrap_tensorflow_internal.ImportGraphDef

def ExperimentalConvertSavedModelToMlir(saved_model_path, exported_names, show_debug_info):
    return _pywrap_tensorflow_internal.ExperimentalConvertSavedModelToMlir(saved_model_path, exported_names, show_debug_info)
ExperimentalConvertSavedModelToMlir = _pywrap_tensorflow_internal.ExperimentalConvertSavedModelToMlir

def ExperimentalRunPassPipeline(mlir_txt, pass_pipeline, show_debug_info):
    return _pywrap_tensorflow_internal.ExperimentalRunPassPipeline(mlir_txt, pass_pipeline, show_debug_info)
ExperimentalRunPassPipeline = _pywrap_tensorflow_internal.ExperimentalRunPassPipeline
