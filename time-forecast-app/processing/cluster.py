...
class Cluster:
    ...
    def run(dict_data):
        ...
        try:
            if len(dict_data) < 3:
                raise Exception("Input file must contain at least 3 rows for clustering.")

            # initializing dictionaries for volume and intermittency
            ...
            logging.error("Exception raised during clustering:")
            logging.error(traceback.format_exc())
        
        # print("DICTIONARIES")
        # print(vol_dict)
        # print(int_dict)
        return final_vol_dict, final_int_dict, vol_dict, int_dict
